...
const _DATA = [
	{
		...
		title: 'Your heritage, your wellness, your legacy.',
		description:
	...
	},
	{
		...
		title: "Your family's story matters.",
		description:
	...
	},
	{
		...
		title: 'Merging DNA insights with cultural legacy.',
		description:
...
|--------------------------------------------------
*/
const _IMAGES = ['/wooden_.png', '/tree.png', '/dna_three.png'];
				...
				<div className="relative">
					<AnimatePresence initial={true} mode="wait">
						<motion.div
							...
							exit={{ opacity: 0, y: -180, marginTop: 100 }}
							transition={{ duration: 1, ease: 'easeOut' }}
							initial={{ opacity: 0, y: -180, marginTop: 100 }}
							className="flex flex-col gap-8 relative pt-24 md:pt-0"
							animate={isInView ? { opacity: 1, y: 0, marginTop: 0 } : {}}
						>
							{/**
                            |--------------------------------------------------
                            | Header
						...
						{[...Array(3)].map((_, index) => {
							return (
								<motion.button
									...
									className="h-[15px] rounded-full bg-[#004000] cursor-pointer"
								/>
							);
						})}
					</div>
                ...
                */}
				<AnimatePresence mode="wait" initial={true}>
					<motion.div
						...
						exit={{ y: 0, marginRight: -100, opacity: 0 }}
						initial={{ y: 0, marginRight: -100, opacity: 0 }}
						animate={isInView ? { y: [0, -20, 0], marginRight: 0, opacity: 1 } : {}}
					>
						<Image
							width={100000}
							height={10000}
							...
							className={cn('max-w-[600px] w-full', currentIndex === 2 && 'sepia-100 saturate-200')}
						/>
					</motion.div>
				</AnimatePresence>
			</div>
